...
RSpec.describe User, type: :model do
  ...
  describe "#words_count" do
    before do
      ...
      other_user = User.create!( :email => "ooxx@example.org", :password => "12345678")
      m1 = Message.create!( :user => other_user , content: "test ooxx")
      Comment.create!( :user => other_user, :message => m1, content: "test ooxx" )

      m2 = Message.create!( :user => @user , content: "test ooxx qqq")
      Comment.create!( :user => @user, :message => m2 , content: "test ooxx applie")
      Comment.create!( :user => @user, :message => m2, content: "test ooxx banan" )
    end
